	...
	<div>
		...
		<div>
			<a href="{{Config::get('app.url')}}/profile/{{ $post_2['user']['username'] }}" style="text-decoration: none;">
				...
				@else
					<img src="http:{{Config::get('app.staticurl')}}/images/profile/avatar-default.png" alt="avatar" height="30px" width="30px" style="height: 30px;width: 30px;background-color: black;vertical-align: middle;border-radius: 50%;margin-left: 5px;margin-right: 10px;">
				@endif
