...
@section('content')
	<h1 style="margin-top:50px; color:#000000; font-family:Helvetica Neue,Helvetica,Arial,sans-serif; font-weight:bold; font-size:21px;">Welcome {{$data['username']}},</h1>
	...
	<a href="{{Config::get('app.url')}}/user/confirm/{{$data['confirm']}}" target="_blank" style="color:#32b1c6; text-decoration:none; font-family:Helvetica Neue,Helvetica,Arial,sans-serif; font-weight:bold; font-size:14px;">Verify your account</a>
