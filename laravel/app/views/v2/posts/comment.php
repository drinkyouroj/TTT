...
foreach($comments as $comment) {
	...
	if(Auth::check()) {
		$reply = '<a class="reply btn-flat-white" data-replyid="'.$comment->id.'" data-postid="'.$comment->post->id.'">Reply</a>';
		...
		{	
			$delete = ' <a title="Delete Comment" class="delete btn-flat-dark-gray" data-delid="'.$comment->id.'">Delete</a>';
		}
	} else  {
