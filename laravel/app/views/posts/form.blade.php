		...
		<div class="col-md-8 col-md-offset-1">
			...
			<div class="page-3 tags">
				<div class="form-group {{$errors->first('tagline_1') ? 'has-error' : '' }}">
					...
					{{ Form::text('tagline_1', Input::old('tagline_1'), array('class'=>'form-control') ) }}
				...
				<div class="form-group {{$errors->first('tagline_2') ? 'has-error' : '' }}">
					...
					{{ Form::text('tagline_2', Input::old('tagline_2'), array('class'=>'form-control')) }}
				...
				<div class="form-group {{$errors->first('tagline_3') ? 'has-error' : '' }}">
					...
					{{ Form::text('tagline_3', Input::old('tagline_3'), array('class'=>'form-control')) }}
